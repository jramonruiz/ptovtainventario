...
<form id="frm_reporte_comprobantes" name="frm_reporte_comprobantes" action="" method="post"> 
        ...
        <section class="content">
          ...
          <div class="row">
                ...
                <!--form role="form"-->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="cmbcomprobante" name="cmbcomprobante" class="form-control">
           ...
           <div class="box-footer">
                    <button type="button" class="btn btn-primary" onClick="javascript:reporte_comprobantes(<?php echo $id_sucursal.','.$id_usuario; ?>);">Ver Reporte</button>
                  </div>  
