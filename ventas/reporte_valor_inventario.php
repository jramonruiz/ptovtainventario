...
<form id="frm_reporte_valor_inventario" name="frm_reporte_valor_inventario" action="" method="post"> 
  ...
  <input type="hidden" id="txttid_usuario" name="txttid_usuario" value="<?php echo $id_usuario; ?>" />
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box-header with-border">
                  <h3 class="box-title">AGRUPACION</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <!--form role="form"-->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="cmbordenarpor" name="cmbordenarpor" class="form-control">
           ...
           <div class="box-footer">
                    <button type="button" class="btn btn-primary" onClick="javascript:reporte_valor_inventario(<?php echo $id_sucursal.','.$id_usuario; ?>);">Ver Reporte</button>
                  </div>  
