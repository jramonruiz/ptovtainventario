...
<form id="frm_reporte_compras" name="frm_reporte_compras" action="" method="post"> 
        ...
        <section class="content">
          ...
          <div class="row">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="cmbagrupacion" name="cmbagrupacion" class="form-control">
                          ...
                          <option value="2">[AJUSTE DE ENTRADA]</option>
                      </select>
                    </div>
                    <div class="form-group">
           ...
           <div class="box-footer">
                    <button type="button" class="btn btn-primary" onClick="javascript:reporte_compras(<?php echo $id_sucursal.','.$id_usuario; ?>);">Ver Reporte</button>
                  </div>  
