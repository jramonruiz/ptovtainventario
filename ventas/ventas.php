    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Ventas de hoy&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="todasventas.php"><i class="fa fa-th"></i><span>Todas las ventas</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:cargar_nueva_venta();"><i class="fa fa-th"></i><span>Nueva Venta</span></a>
            <?php
...
$listado=  mysql_query("select tv.id_venta,tv.folio_venta,tv.fecha_venta,tv.total_venta,tv.nombre_cliente,tv.total_pagar,tv.devolucion,tv.tipo_operacion,tv.venta_cancelada,tv.merma,tv.folioempresa from tventas tv inner join cusuarios cu on tv.id_usuario=cu.id_usuario where cu.id_sucursal=$id_sucursal and tv.tipo_operacion>0 and tv.merma=0 and tv.fecha_venta=CURDATE() order by tv.id_venta DESC");
