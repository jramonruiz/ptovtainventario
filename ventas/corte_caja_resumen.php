...
<form id="frm_corte_caja_resumen" name="frm_corte_caja_resumen" action="" method="post"> 
      ...
      <div class="content-wrapper">
		...
		<input type="text" id="datepicker2" name="datepicker2" /> 
                  ...
                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:corte_caja_diario_resumen();">Ver Reporte</button>
                  </div>
