...
<form id="frm_reporte_articulos" name="frm_reporte_articulos" action="" method="post"> 
        ...
        <section class="content">
          ...
          <div class="row">
                ...
                <!--form role="form"-->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="cmbagrupacion" name="cmbagrupacion" class="form-control">
           ...
           <div class="box-footer">
                    <button type="button" class="btn btn-primary" onClick="javascript:reporte_articulos(<?php echo $id_sucursal.','.$id_usuario; ?>);">Ver Reporte</button>
                  </div>  
