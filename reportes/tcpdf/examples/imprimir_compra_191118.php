...
$table3.= '<table border="0" cellspacing="0" cellpadding="10" >';
			...
			$table3.= '<tr><td align="right">TOTAL DE LA COMPRA: $ '.mb_convert_encoding($MostrarFila['total_compra'], "UTF-8").'</td></tr>';	
				
			
$table3.= '</table>';
			

$tipo_documento=mb_convert_encoding($MostrarFila['tipo_documento'], "UTF-8");
$folio_documento=mb_convert_encoding($MostrarFila['folio_documento'], "UTF-8");
$cadena=$tipo_documento.': '.$folio_documento;

$pdf->SetFont('courier', 'B', 8);
$pdf->Ln(6);
$pdf->Cell(0, 5,'COMPROBANTE DE COMPRA', 0, 1, 'C', 0, '', 0);
$pdf->Ln(3);
$pdf->Cell(0, 5,$cadena, 0, 1, 'C', 0, '', 0);
$pdf->Ln(16);
