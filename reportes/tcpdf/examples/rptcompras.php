...
$pdf->AddPage('P', 'A4');
       ...
       <tr align="center" border="1"> 
		    <th align="center" border="1"><b>FECHA DE LA COMPRA</b></th>
		    <th align="center" border="1"><b>TOTAL DE LA COMPRA</b></th>			
			<th align="center" border="1"><b>NOMBRE DEL PROVEEDOR</b></th>
			<th align="center" border="1"><b>DIRECCION DEL PROVEEDOR</b> </th></tr></thead>';
					
				$Resultado2=mysql_query("select * from vcompras where (fechacompra between '$fecha_inicial' and '$fecha_final')");	
				while($MostrarFila2=mysql_fetch_array($Resultado2))
				{
    $table2.='<tr><td align="center" border="1">'.$MostrarFila2['fechacompra'].'</td>
			                  <td align="center" border="1">'.$MostrarFila2['totalcompra'].'</td>'.'<td align="center" border="1">'.$MostrarFila2['nombre_empresa'].'</td>'.'<td align="center" border="1">'.$MostrarFila2['direccion_proveedor'].'</td>';
			$table2.= '</tr>';
				}
			$table2.= '</table>';	
...
$pdf->Ln(6);
$pdf->Cell(0, 5,'REPORTE DE COMPRAS', 0, 1, 'C', 0, '', 0);
$pdf->Ln(6);
