...
$pdf->AddPage('P', 'A4');
       ...
       <tr align="center" border="1"> 
			...
			<th align="center" border="1"><b>SOTCK MINIMO</b> </th></tr></thead>';
				...
				$Resultado2=mysql_query("select codigoarticulo,descripcion,cantidadexistencia,stockminimo from tableinventario where estado='FALTANTE'");	
...
$pdf->Ln(6);
$pdf->Cell(0, 5,'LISTADO DE ARTICULOS FALTANTES', 0, 1, 'C', 0, '', 0);
$pdf->Ln(16);
$pdf->writeHTML($table2, true, false, false, false, '');
$table2="";
	

$pdf->Output('rptarticulos_faltantes.pdf', 'I');