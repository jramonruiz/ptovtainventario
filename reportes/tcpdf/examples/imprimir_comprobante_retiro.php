...
//$pdf->AddPage('P', 'A4');
		...
		$table5.= '<table border="0">';
         $table5.= '
         <tr>
            <td align="center" border="0" colspan="3"><b>BLUSH DISTRIBUIDOR DE PRODUCTOS DE BELLEZA</b></td>
         </tr>
         <tr>
            <td align="center" border="0" colspan="3"><b>'.$descripcion_sucursal.'</b></td>
         </tr>
          <tr>
            <td align="center" border="0" colspan="3"><b>RETIRO DE EFECTIVO</b></td>
          </tr>
          <tr>
            <td align="left" border="0" colspan="3"><b>FOLIO:'.$id_retiro.'</b></td>
          </tr>
          <tr>
            <td align="left" border="0" colspan="3"><b>USUARIO:'.$nombre_usuario.'</b></td>
          </tr>
         <tr>
	         <td align="left" border="0"><b>CAJA</b></td>
	          <td align="left" border="0"><b>FECHA</b></td>
	          <td align="left" border="0"><b>HORA</b></td>
	     </tr>
		 <tr>
		 	<td align="left" colspan="1">'.$descripcion_caja.'</td>
		 	<td align="left" colspan="1">'.$fecha_retiro.'</td>
		 	<td align="left" colspan="1">'.$hora_retiro.'</td>
         </tr>
         <tr>
		 	<td align="left" colspan="2">'.$motivo_retirar.'</td>
		 	<td align="left" colspan="1">$'.$monto_retirar.'</td>
         <tr>';
