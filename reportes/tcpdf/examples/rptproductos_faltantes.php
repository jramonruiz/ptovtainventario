...
class MYPDF extends TCPDF {
	...
	public function Footer() {
		...
		$this->Cell(0, 10, 'Reporte productos faltantes', 'T', false, 'C');				
		$this->SetY(-15);
		// Set font
		//$this->SetFont('helvetica', 'I', 8);
		// Page number
...
//$pdf->AddPage('P', 'A4');
			...
			$table1.= '<table><thead border="0">
       		<tr>
				<td align="center" border="0" colspan="5">
					<b>NOMBRE DE LA EMPRESA</b><br>
					<b>DATO 1 DE LA EMPRESA</b><br>
					<b>REPORTE PRODUCTOS FALTANTES</b><br>
					<b>FECHA:'.$hoy.'</b><br>
			...
			<tr align="center" border="0">
				<td colspan="5" style="border-bottom:solid 1px color:#000000;">&nbsp;</td>
			</tr> 
			</thead>
			<tr>
				<td align="center" border="1">CODIGO</td><td align="center" border="1">DESCRIPCION</td><td align="center" border="1">EXISTENCIA</td><td align="center" border="1">S. MINIMO</td><td align="center" border="1">S. MAXIMO</td>
			</tr>';

			$Resultado2=mysql_query("select * from cproductos where id_sucursal=$id_sucursal");	
				while($MostrarFila2=mysql_fetch_array($Resultado2))
				{
					...
					$stock_minimo=utf8_encode($MostrarFila2['stock_minimo']);
					$stock_maximo=utf8_encode($MostrarFila2['stock_maximo']);
				 
				 if($cantidad_existencia<$stock_minimo)
			  	{
			  		$table1.='<tr><td align="left" border="1">'.$codigo_barras.'</td><td align="left" border="1">'.$descripcion.'</td>'.'<td align="center" border="1">'.$cantidad_existencia.'</td>'.'<td align="center" border="1">'.$stock_minimo.'</td>'.'<td align="center" border="1">'.$stock_maximo.'</td>';
					  $table1.= '</tr>';
				}
...
$pdf->Output('reporteproductosfaltantes.pdf', 'I');