...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
    	<td colspan="3" align="left" class="fondo_titulo_formularios">&nbsp;&nbsp;&nbsp;Reporte de Productos Faltantes</td>
    </tr>
	<tr>
    	<td colspan="3" align="left" class="fondo_titulo_formularios">&nbsp;&nbsp;&nbsp;</td>
    </tr>
	...
	<tr>
    	<td colspan="3" align="left"><span class="letras_formulario">Este reporte visualizara unicamente los productos que tengan como CANTIDAD EN EXISTENCIA MENOR que al STOCK MINIMO</span></td>
	</tr>       
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
        ...
        &nbsp;&nbsp;
        <input class="btn btnapply" name="submit" type="button" id="btnAceptar" style="top:0px; left: 250px; position: static; cursor:pointer;"  onclick="javascript:reporte_productos_faltantes();"value="Aceptar"/>
        <input type="button" id="btnaceptar" name="btnaceptar" value="Aceptar" onclick="javascript:reporte_productos_faltantes();" style="display:none;" />
