...
$listado=  mysql_query("select id_producto_venta,cantidad,precio_venta,descuento from tproductos_venta where id_usuario=".$id_usuario." and id_venta=0 and id_area_venta=".$txtid_areaventa);
