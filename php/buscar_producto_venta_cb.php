...
$rs = mysql_query("SELECT id_producto,codigo_barras,descripcion,precio_venta,cantidad_existencia,descto_salon,descto_mayorista,precio_compra FROM cproductos where codigo_barras='$txtproductodesc' and id_sucursal=$id_sucursal");
