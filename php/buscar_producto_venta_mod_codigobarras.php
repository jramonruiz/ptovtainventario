...
$rs = mysql_query("SELECT id_producto,codigo_barras,descripcion,precio_venta,cantidad_existencia,descto_salon,descto_mayorista FROM cproductos where codigo_barras='$txtproductodesc' and id_sucursal=$id_sucursal");
...
if($id_producto_buscar!=0)
	{
		...
		echo "1,".$id_producto_buscar.",".$codigo_barras.",".$descripcion.",".$precio_venta.",".$cantidad_existencia.",".$descto_salon.",".$descto_mayorista;		
	}
else
	{
		echo "0";
