...
$txtid_productomod=utf8_decode($_POST['txtid_producto']);
$txtcantidad_productomod=utf8_decode($_POST['txtcantidad_productobuslis']);
...
if($id_producto_vendido_buscado==0)
{
		...
		$sql= mysql_query("insert into tproductos_venta(descripcion_producto,cantidad,precio_venta,subtotal,id_usuario,id_producto,descuento,precio_neto,porcentaje_descuento,id_area_venta) values(\"$txtdescripcion_producto\",$txtcantidad_productomod,$txtprecio_producto,$importe,$id_usuario,$txtid_productomod,$desctotal,$precio_neto,$txtdescuento_productomod,$txtid_areaventa)");
