...
<form id="frm_nuevo_metodo_pago" name="frm_nuevo_metodo_pago" action="" method="post"> 
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre del metodo de pago</label>
                        <input id="txtnombre_metodo_pago" name="txtnombre_metodo_pago" class="form-control input-lg" type="text" placeholder="escriba el metodo de pago: efectivo, credito, tarjeta de credito, tarjeta de debito">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_metodo_pago();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
