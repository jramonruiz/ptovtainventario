...
$idareaventa=$_GET["idareaventa"];
if($idareaventa>0)
{
$query = "select * from careasventa where id_area_venta=$idareaventa";
$result = mysql_query($query) or die("SQL Error 1: " . mysql_error());
// get data and store in a json array
while ($row = mysql_fetch_array($result)) 
{
$id_area_venta=utf8_encode($row[0]);
$nombre_area=utf8_encode($row[1]);
$id_caja=utf8_encode($row[2]);
}

$queryc = "select * from ccajas where id_caja=$id_caja";
$resultc = mysql_query($queryc) or die("SQL Error 1: " . mysql_error());
// get data and store in a json array
while ($rowc = mysql_fetch_array($resultc)) 
{
$id_cajab=utf8_encode($rowc[0]);
$descripcion_caja=utf8_encode($rowc[1]);
}
...
<form id="frm_modificar_area_venta" name="frm_modificar_area_venta" action="" method="post"> 
  ...
  <input type="hidden" id="txtid_areaventa" name="txtid_areaventa" value="<?php echo $id_area_venta; ?>" /> 
              ...
              <div class="box box-primary">
                ...
                <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre area de venta</label>
                        <input id="txtnombre_areaventa" name="txtnombre_areaventa" class="form-control input-lg" type="text" placeholder="" value="<?php echo $nombre_area; ?>">
                    </div>
                    <div class="form-group">
                      <input list="cajas" name="txtnombre_caja" id="txtnombre_caja" value="<?php echo $descripcion_caja; ?>">
                        <datalist id="cajas">
                             <?php
                  ...
                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:modificar_datos_area_venta();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
