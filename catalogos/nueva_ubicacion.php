...
<form id="frm_nueva_ubicacion" name="frm_nueva_ubicacion" action="" method="post"> 
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre ubicacion</label>
                        <input id="txtnombre_ubicacion" name="txtnombre_ubicacion" class="form-control input-lg" type="text" placeholder="escriba el nombre de la ubicacion, ejemplo: vitrina">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_ubicacion();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
