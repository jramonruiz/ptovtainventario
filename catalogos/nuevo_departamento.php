...
<form id="frm_nuevo_departamento" name="frm_nuevo_departamento" action="" method="post"> 
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre</label>
                        <input id="txtdesc_departamento" name="txtdesc_departamento" class="form-control input-lg" type="text" placeholder="escriba la descripcion del departamento, ejemplo: bolsa, cabello, cejas, manicure">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_departamento();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
