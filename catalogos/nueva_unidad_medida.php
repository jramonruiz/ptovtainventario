...
<form id="frm_nuevo_unidad_medida" name="frm_nuevo_unidad_medida" action="" method="post"> 
                ...
                <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre unidad de medida</label>
                        <input id="txtnombre_unidad_medida" name="txtnombre_unidad_medida" class="form-control input-lg" type="text" placeholder="escriba el nombre de la unidad de medida: pieza, caja">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_unidad_medida();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
