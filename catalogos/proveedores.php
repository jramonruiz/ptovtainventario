...
<form id="frm_lista_proveedores" name="frm_lista_proveedores" action="" method="post"> 
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Lista de Proveedores&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="nuevo_proveedor.php"><i class="fa fa-th"></i><span>     Nuevo proveedor</span></a>
          </h1>
        </section>
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
<?php 
$listado=  mysql_query("select id_proveedor,nombre_empresa,rfc_empresa,calle,nombre_contacto,telefono1_contacto,telefono2_contacto,telefono3_contacto,correo_contacto,estado,municipio from cproveedores order by nombre_empresa");
...
?>				
                      <tr>
                        ...
                        <td><?php echo $municipio; ?></td>
						            <td><button type="button" class="btn btn-warning btn-fa-pencil-square-o" onClick="javascript:modificar_proveedor(<?php echo $id_proveedor; ?>);"><i class="fa fa-pencil-square-o"></i></button></td>
                      </tr>
<?php
				}
?>					  
