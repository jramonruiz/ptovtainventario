...
<form id="frm_nueva_categoria" name="frm_nueva_categoria" action="" method="post"> 
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre de la categoria</label>
                        <input id="txtdesc_categoria" name="txtdesc_categoria" class="form-control input-lg" type="text" placeholder="escriba la descripcion de la categoria">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_categoria();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
