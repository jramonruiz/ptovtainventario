...
<form id="frm_nuevo_impuesto" name="frm_nuevo_impuesto" action="" method="post"> 
  ...
  <input type="hidden" id="txtid_impuesto_eliminar" name="txtid_impuesto_eliminar" value="" />
    <div class="wrapper">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre del impuesto</label>
                        <input id="txtnombre_impuesto" name="txtnombre_impuesto" class="form-control input-lg" type="text" placeholder="capture el nombre del impuesto">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Porcentaje</label>
                        <input id="txtporcentaje" name="txtporcentaje" class="form-control input-lg" type="number" placeholder="capture el porcentaje del impuesto, ejemplo: 10">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_impuesto();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
