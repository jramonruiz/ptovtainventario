 ...
 $chref31="#";
                ...
                $listado=  mysql_query("select tmu.id_menu_usuario,tms.menu,tmu.acceso,tmu.id_menu from tmenu_sistema tms inner join tmenu_usuario tmu on tms.id_menu=tmu.id_menu where tmu.id_usuario=$id_usuario order by tmu.id_menu");
                   while($reg=  mysql_fetch_array($listado))
                   {
                              ...
                              {
                                  $chref12="impuestos.php";//PROCEDIMIENTOS SUBMENU
                              }

                              if($id_menu==13 and $acceso==1)
                              {
                                  $chref13="metodospago.php";//PACIENTES SUBMENU
                              }

                              if($id_menu==14 and $acceso==1)
                              {
                                  $chref14="clientes.php";// ESTADISTICAS CON SUBMENU
                              }

                              if($id_menu==15 and $acceso==1)
                              {
                                  $chref15="proveedores.php";//ENFERMEDADES SUBMENU
                              }

                              if($id_menu==16 and $acceso==1)
                              {
                                  $chref16="areasventa.php";//PROCEDIMIENTOS SUBMENU
                              }

                              if($id_menu==17 and $acceso==1)
                              {
                                  $chref17="unidadesmedida.php";//PACIENTES SUBMENU
                              }

                              if($id_menu==18 and $acceso==1)
                              {
                                  $chref18="ubicaciones.php";//USUARIOS MENU PRINCIPAL
                              }

                              if($id_menu==19 and $acceso==1)
                              {
                                  $chref19="sucursales.php";
                              }
                              ...
                              {
                                  $chref21="marcas.php";//COBROS MENU PRINCIPAL
                              }

                              if($id_menu==22 and $acceso==1)
                              {
                                  $chref22="departamentos.php";//COBROS MENU PRINCIPAL
                              }

                              if($id_menu==23 and $acceso==1)
                              {
                                  $chref23="categorias.php";//COBROS MENU PRINCIPAL
                              }
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo $chref8; ?>"><i class="fa fa-circle-o"></i>Corte de Caja</a></li>
              </ul>     
            </li>
            <li class="treeview">
              <a href="#">
