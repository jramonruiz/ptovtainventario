                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre de la marca</label>
                        <input id="txtnombre_marca" name="txtnombre_marca" class="form-control input-lg" type="text" placeholder="">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:alta_marca();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
