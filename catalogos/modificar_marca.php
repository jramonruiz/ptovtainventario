...
if($idmarca>0)
{
$query = "select * from cmarcas where id_marca=$idmarca";
$result = mysql_query($query) or die("SQL Error 1: " . mysql_error());
// get data and store in a json array
while ($row = mysql_fetch_array($result)) 
{
$id_marca=utf8_encode($row[0]);
$descripcion_marca=mb_convert_encoding($row[1], "UTF-8");
}
}
?>
<!DOCTYPE html>
...
<form id="frm_modificar_marca" name="frm_modificar_marca" action="" method="post"> 
  ...
  <input type="hidden" id="txtid_marca" name="txtid_marca" value="<?php echo $id_marca; ?>" /> 
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nombre de la marca</label>
                        <input id="txtnombre_marca" name="txtnombre_marca" class="form-control input-lg" type="text" placeholder="" value="<?php echo $descripcion_marca; ?>">
                    </div>
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:modificar_datos_marca();">Guardar</button>
                  </div>
                </form>
              </div><!-- /.box -->
