 ...
 $chref32="#";
                ...
                $listado=  mysql_query("select tmu.id_menu_usuario,tms.menu,tmu.acceso,tmu.id_menu from tmenu_sistema tms inner join tmenu_usuario tmu on tms.id_menu=tmu.id_menu where tmu.id_usuario=$id_usuario order by tmu.id_menu");
                   while($reg=  mysql_fetch_array($listado))
                   {
                              ...
                              if($id_menu==32 and $acceso==1)
                              {
                                  $chref31="ventas/nuevo_aviso_ticket.php";//COBROS MENU PRINCIPAL
                              }
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                {
                ?>
                <li><a href="<?php echo $chref24; ?>"><i class="fa fa-circle-o"></i> <span>Cuentas por cobrar</span></a></li>
                <?php
                }
            	?>
            	<?php
                ...
                {
                ?>
                <li><a href="<?php echo $chref25; ?>"><i class="fa fa-circle-o"></i> <span>Cuentas por pagar</span></a></li>
                <?php
                }
            	?>
               </ul>     
            ...
            <li>
              <a href="<?php echo $chref31; ?>">
                <i class="fa fa-th"></i> <span>Avisos en Ticket</span>
              </a>
            </li>
            <?php
            }
