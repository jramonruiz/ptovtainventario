  ...
  <input type="hidden" id="txtid_usuario_buscar" name="txtid_usuario_buscar" value="" />
                ...
                <div class="box-body">
                  <form method="post" action="" enctype="multipart/form-data" id="frm-restore">
                    <div class="form-group">
                      <label class="form-control-label" for="backup_file">Seleccione un archivo para restaurar</label>
                        <div class="col-10">
                          <input type="file" name="backup_file" class="form-control" />
                        </div>
                        <div class="col-2">
                          <button type="button" id="restore" class="btn-info btn btn-lg">Restaurar</button>
                         </div> 
                    </div>
                  </form>
                </div>
    ...
    <script>
      ...
      $('#btnBack').click(function(event) {
        ...
        jQuery.each(jQuery('#frm-restore')[0].files, function(i, file) {
            data.append('file-'+i, file);
        });
        var url = '../php/restoreBD.php';
        $.ajax({
          url: '/path/to/file',
          type: 'POST',
          method: 'POST',
