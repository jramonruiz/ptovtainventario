...
<body>
<form id="frm_consultar_usuario" name="frm_consultar_usuario" action="" method="post"> 
...
<table width="100%" cellpadding="0" cellspacing="0" align="center">
	<tr>
    	<td colspan="3" align="left"><span class="letras_formularios_titulo">Consultar Usuario</span></td>
    </tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>  
	...
	<td colspan="3" align="left" class="tablacontenido">
		<span class="letras_formulario">Nombre del usuario a buscar:</span><input type="text" id="buscar" name="buscar" style="width:300px;" />&nbsp;&nbsp;<button type="button" class="button-black" onclick="javascript:consultar_usuario();"><span onclick="javascript:consultar_usuario();">Buscar</span></button>
	</td>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>    
	...
	<tr>
		<td colspan="3" align="left" class="tablacontenido">
			...
			<select id="cmbactivo_usuario" name="cmbactivo_usuario" disabled="disabled">
				<option selected="selected" value="0">[Seleccione una opcion]</option>
